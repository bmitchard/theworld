        ...
        public void EnsureSeedData()
        {
            if (!_context.Trips.Any())
            {
                ...
                var worldTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                        new Stop() {Order = 0, Latitude=33.748995, Longitude=-84.38798, Name="Atlanta, Georgia", Arrival=DateTime.Parse("Jun 3, 2014") },
                        ...
                        new Stop() {Order = 6, Latitude=33.748995, Longitude=-84.387982, Name="Atlanta, Georgia", Arrival=DateTime.Parse("Jul 24, 2014") }
                    }
                };
